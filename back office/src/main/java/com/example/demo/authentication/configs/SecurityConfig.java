package com.example.demo.authentication.configs;

import java.util.Arrays;

import com.example.demo.authentication.requestFilter.JwtRequestFilter;
...
import com.example.demo.authentication.services.UtilisateurService;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    return http
      ...
      .authorizeHttpRequests(req -> {
        req
          .requestMatchers("/login/register","/login/auth","/free/**","/voitures/**","/annonce/all","/annonce/filter").permitAll()
          .anyRequest()
